...
export const LoadingOverlay: React.FC<LoadingOverlayProps> = ({
  ...
  return (
    <motion.div
      ...
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      className='absolute inset-0 z-[200] flex flex-col items-center justify-center bg-black/90 backdrop-blur-md'
    >
      <div className='relative flex flex-col items-center w-64'>
        ...
        >
          <span className='text-white/90 text-sm font-light tracking-[0.3em] uppercase mb-4 text-center'>
            {message}
          </span>
