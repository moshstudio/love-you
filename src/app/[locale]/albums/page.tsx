...
export default function AlbumsPage() {
  ...
  return (
    <div className='min-h-screen bg-background text-foreground font-sans relative overflow-hidden'>
      ...
      {/* Header */}
      <header className='fixed top-0 left-0 right-0 z-50 border-b border-rose-100/20 bg-white/20 dark:bg-black/20 backdrop-blur-md'>
        <div className='max-w-7xl mx-auto px-6 h-20 flex justify-between items-center'>
          <div className='flex items-center gap-4'>
            ...
            <span className='text-xl md:text-2xl font-black tracking-tighter bg-clip-text text-transparent bg-gradient-to-r from-rose-400 to-purple-500'>
              {navT("brand")}
            </span>
          </div>
          ...
          <div className='flex items-center gap-6'>
            ...
            <button
              ...
              className='flex items-center gap-2 text-xs font-bold text-rose-400 border border-rose-100 px-4 py-2 rounded-full hover:bg-rose-50 transition-all'
            >
      ...
      {/* Main Content */}
      <main className='relative z-10 pt-32 pb-20 h-screen flex flex-col'>
        <AlbumList
